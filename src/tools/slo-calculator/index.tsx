...
export const meta: ToolMeta = {
  ...
  blurb:
    "Convert availability targets into minutes of error budget per window. Paste a target, pick a window, copy the math.",
  tags: ["slo", "math"],
};
      ...
      <div class="card">
        <div class="form-grid">
          ...
          <select
            id="window"
            value={win}
            onChange={(e) => setWin((e.target as HTMLSelectElement).value)}
          >
